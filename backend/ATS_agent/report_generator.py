...
try:
    from ATS_agent.config import LANGUAGE_CATEGORY_LABELS, SCORE_WEIGHTS
    from ATS_agent.utils import configure_plot_fonts, restore_plot_fonts, render_markdown
except ModuleNotFoundError:
    from config import LANGUAGE_CATEGORY_LABELS, SCORE_WEIGHTS
