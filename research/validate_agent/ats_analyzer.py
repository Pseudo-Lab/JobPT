...
from ats_simulation import ATSSimulator
...
class ATSAnalyzer:
    ...
    def extract_and_preprocess(self):
        ...
        try:
            ...
            try:
                import sys
                sys.path.insert(0, '/mnt/e/code/GJS/JobPT-main/research/validate_agent')
                from upstage_parser import upstage_parser
                upstage_available = True
            except ImportError:
        ...
        if upstage_available:
            try:
                result = upstage_parser(self.cv_path)
